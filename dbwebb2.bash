...
function dbwebb-inspect()
{
    ...
    local command1=
    local command2="$SSH_CMD \"dbwebb-inspect --config /home/saxon/students/dbwebb/config-inspect --archive /home/saxon/students/dbwebb/archive/ --publish-url $DBW_BASEURL --publish-to ~$DBW_USER/$DBW_REMOTE_WWWDIR --base-url $DBW_WWW_HOST~$inspecUser/$DBW_REMOTE_BASEDIR ~$inspecUser/$DBW_REMOTE_BASEDIR/$course $kmom\" | tee '$log';"
