...
function dbwebb-inspect()
{
    ...
    local command1=
    local command2="$SSH_CMD 'dbwebb-inspect --publish-url \"$DBW_BASEURL\" --publish-to \"\~$USER/$DBW_REMOTE_BASEDIR\" --base-url $DBW_WWW_HOST~$who/$DBW_REMOTE_BASEDIR/ \"\~$who/$DBW_REMOTE_BASEDIR/$DBW_COURSE\" $kmom' | tee '$log';"
