...
RSYNC_CMD="rsync -av $RSYNC_CHMOD --exclude .git --exclude .gitignore --exclude literature --exclude tutorial --exclude slide --exclude .solution --exclude old --exclude .default --exclude platforms/ --exclude .DS_Store --delete --delete-excluded -e \"ssh $DBW_SSH_KEY_OPTION\""
...
DBW_COURSE_REPOS=( 'python' 'javascript1' 'linux' 'webapp' 'oopython' 'htmlphp' 'design' 'oophp' 'phpmvc' 'javascript' 'webgl' )
DBW_REPO="dbwebb-cli"
