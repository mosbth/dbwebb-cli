...
# Add a second .dbwebb.exclude2
RSYNC_EXCLUDE2="$DBW_COURSE_DIR/.dbwebb.exclude2"
if [ -f "$RSYNC_EXCLUDE2" ]; then
    RSYNC_EXCLUDE2="--exclude-from='$RSYNC_EXCLUDE2'"
else
    RSYNC_EXCLUDE2=""
fi
...
RSYNC_CMD="rsync -av $RSYNC_CHMOD $RSYNC_EXCLUDE $RSYNC_INCLUDE $RSYNC_EXCLUDE2 --delete --delete-excluded -e \"ssh $DBW_SSH_KEY_OPTION\""
