...
RSYNC_CMD="rsync -av $RSYNC_CHMOD --delete --exclude .git --exclude .gitignore --exclude literature --exclude tutorial --exclude slide --exclude old --exclude .default -e \"ssh $DBW_SSH_KEY_OPTION\""
